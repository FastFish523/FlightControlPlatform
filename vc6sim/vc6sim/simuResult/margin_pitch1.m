...
% p1= -a33+ a34- a22- a24t- a11;
% p2= a31*a14-a31*a13+ a22*a33- a22*a34 -a24+ a33*a24t+ a33*a11- a34*a11+ a22*a11+a24t*a11;
% p3= -a21*a14- a31*a22*a14+ a22*a31*a13+ a24t*a31*a13+ a24*a33- a22*a33*a11+ a22*a34*a11+ a24*a11- a33*a11*a24t;
% p4= a21*a33*a14- a13*a21*a34+ a24*a31*a13- a24*a33*a11;
% c=[1 p1 p2 p3 p4];
% roots(c);
   ...
   [Gm,Pm,wcg,wcp]=margin(-AIZ*d2r*body*Kwz*Gr);
...
%    SysOpen= tf(SysOpen.num{1},SysOpen.den{1},'inputdelay',0.05);
